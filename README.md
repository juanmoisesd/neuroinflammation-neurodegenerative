# Neuroinflammation and Neurodegenerative Disorders Dashboard
...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/neuroinflammation-neurodegenerative/)
[![DOI](https://img.shields.io/badge/DOI-10.7910/DVN/X2TQQA-blue)](https://doi.org/10.7910/DVN/X2TQQA)


## Overview

Interactive dashboard: Neuroinflammation in Alzheimer's, Parkinson's and Multiple Sclerosis. DOI: 10.7910/DVN/X2TQQA

## 🌐 Live Dashboard

**[Open Interactive Dashboard](https://juanmoisesd.github.io/neuroinflammation-neurodegenerative/)**

## Resources

| Resource | Link |
|---|---|
| Dataset DOI | [doi.org/10.7910/DVN/X2TQQA](https://doi.org/10.7910/DVN/X2TQQA) |
| Author | [juanmoisesdelaserna.es](https://juanmoisesdelaserna.es) |
| ORCID | [0000-0002-8401-8018](https://orcid.org/0000-0002-8401-8018) |

## How to Cite

> de la Serna Tuya, J.M. (2026). *Neuroinflammation and Neurodegenerative Disorders Dashboard*. GitHub. https://github.com/juanmoisesd/neuroinflammation-neurodegenerative
Also cite the dataset: https://doi.org/10.7910/DVN/X2TQQA
...
|---|---|
| Status | 🟢 Published |
| DOI | [10.7910/DVN/X2TQQA](https://doi.org/10.7910/DVN/X2TQQA) |
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Interactive dashboard: Neuroinflammation in Alzheimer's, Parkinson's and Multiple Sclerosis. DOI: 10.7910/DVN/X2TQQA* [Dataset]. GitHub. https://github.com/juanmoisesd/neuroinflammation-neurodegenerative

**BibTeX**
```bibtex
@dataset{delaserna2025_neuroinflammation_neurodegener,
