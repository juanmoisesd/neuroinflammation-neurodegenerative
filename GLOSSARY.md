...
### APA 7
> De la Serna Tuya, J. M. (2025). *Glosario de términos clave: neuroinflammation-neurodegenerative* [Glossary of key terms]. GitHub. https://github.com/juanmoisesd/neuroinflammation-neurodegenerative/blob/main/GLOSSARY.md

### BibTeX
```bibtex
@misc{delaserna2025_neuroinflammation_neurodegener,
  author       = {De la Serna Tuya, Juan Moisés},
  title        = {Glosario de Términos Clave / Glossary of Key Terms: neuroinflammation-neurodegenerative},
  year         = {2025},
  publisher    = {GitHub},
  url          = {https://github.com/juanmoisesd/neuroinflammation-neurodegenerative/blob/main/GLOSSARY.md},
  note         = {ORCID: 0000-0002-8401-8018}
}
```

### Chicago
> De la Serna Tuya, Juan Moisés. "Glosario de Términos Clave: neuroinflammation-neurodegenerative." GitHub, 2025. https://github.com/juanmoisesd/neuroinflammation-neurodegenerative/blob/main/GLOSSARY.md.
